  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
      ...
      <FadeInOnScroll>
        <div className="bg-slate-800/50 rounded-2xl p-5 md:p-6 border border-slate-700">
          <div className="flex items-center gap-2 mb-4">
            <span className="text-slate-400 text-sm font-medium uppercase tracking-wider">Now</span>
          </div>
          
          {/* Visual representation */}
          <div className="flex flex-col items-center mb-4">
            <div className="relative">
              <CloudRain className="w-12 h-12 md:w-16 md:h-16 text-slate-500 mb-2" />
      ...
      <div className="flex justify-center md:hidden">
        <div className="w-0 h-0 border-l-[20px] border-r-[20px] border-t-[16px] border-l-transparent border-r-transparent border-t-amber-400"></div>
      </div>

      {/* WITH SALES TEAM - Solution State */}
      <FadeInOnScroll delay={0.1}>
        <div className="bg-gradient-to-br from-amber-900/30 to-amber-800/20 rounded-2xl p-5 md:p-6 border border-amber-500/30">
          <div className="flex items-center gap-2 mb-4">
            <span className="text-amber-400 text-sm font-medium uppercase tracking-wider">With Sales Team</span>
          </div>
          
          {/* Visual representation */}
          <div className="flex flex-col items-center mb-4">
            <div className="relative">
              <Users className="w-12 h-12 md:w-16 md:h-16 text-amber-400 mb-2" />
          ...
          <div className="grid grid-cols-3 gap-2 mb-4">
            <div className="text-center bg-slate-800/50 rounded-lg py-2 px-1">
            ...
            <div className="text-center bg-slate-800/50 rounded-lg py-2 px-1">
              ...
              <span className="text-slate-400 text-xs">Convert</span>
            </div>
          </div>
        </div>
      </FadeInOnScroll>
