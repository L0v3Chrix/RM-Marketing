...
const roiComparison = [
  ...
  { label: "Year 1 Revenue Increase", value: "$230-380K", color: "text-green" },
  { label: "Year 1 ROI", value: "4-6x", color: "text-green" },
];
      ...
      <Container>
          ...
          <FadeInOnScroll delay={0.1}>
            <Card variant="highlight" padding="large" className="h-full">
              <div className="text-center mb-6">
                ...
                <div className="text-5xl md:text-6xl font-bold text-text-heading mb-2">
                  $<CountUp end={8000} duration={1.5} />
                </div>
                <p className="text-text-muted">30 Days | Chrix + Sara Selling</p>
              </div>

              <div className="border-t border-green/30 pt-6 mb-6">
                <h4 className="text-sm font-medium text-text-body uppercase mb-4">Payment Structure</h4>
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="text-center">
                    <p className="text-2xl font-bold text-green">$4,000</p>
              ...
              <h4 className="text-sm font-medium text-text-body uppercase mb-4">What You Get</h4>
            ...
            <Card variant="default" padding="large" className="h-full">
              ...
              <div className="border-t border-border-light pt-6 mb-6">
                ...
                <div className="grid grid-cols-3 gap-2 text-center">
                  <div>
                    <p className="text-xl font-bold text-green">$12K</p>
                ...
                <p className="text-text-muted text-xs text-center mt-2">+ Commission starting Day 45</p>
              </div>
              ...
              <div className="space-y-4">
                {phase2Months.map((month, index) => (
                  <div key={index}>
                    <p className="text-text-heading font-medium text-sm mb-1">{month.month}</p>
        ...
        <FadeInOnScroll delay={0.2}>
          <Card variant="opportunity" padding="large" className="text-center mb-16 max-w-2xl mx-auto">
            <DollarSign className="w-12 h-12 text-blue mx-auto mb-4" />
            <h3 className="text-xl font-semibold text-text-heading mb-6">Total Investment Summary</h3>
            <div className="grid grid-cols-2 gap-4 text-left mb-6">
              <div className="text-text-body">Phase 1 (Pressure Test)</div>
              <div className="text-green font-semibold text-right">$8,000</div>
              <div className="text-text-body">Phase 2 (Buildout)</div>
              <div className="text-green font-semibold text-right">$36,000</div>
              <div className="text-text-heading font-bold border-t border-border-light pt-2">Main Engagement</div>
              <div className="text-green font-bold text-right border-t border-border-light pt-2">$44,000</div>
              <div className="text-text-muted">Ongoing Support (est.)</div>
              <div className="text-text-body text-right">$14-21K</div>
              <div className="text-text-muted">Commission</div>
              <div className="text-text-body text-right">Variable</div>
              <div className="text-text-heading font-bold border-t border-border-light pt-2">Full Year (Est.)</div>
              <div className="text-green font-bold text-right border-t border-border-light pt-2">$58-65K</div>
            </div>
          </Card>
        </FadeInOnScroll>
        ...
        {/* Opportunity Cost */}
        <FadeInOnScroll delay={0.2}>
          <Card variant="problem" padding="large" className="max-w-3xl mx-auto mb-16">
            ...
            <div className="grid grid-cols-3 gap-4 text-center mb-6">
              <div>
                ...
                <p className="text-xl font-bold text-text-body">$15K/mo</p>
                <p className="text-red text-sm">$180K/year</p>
              </div>
              <div>
                <p className="text-text-muted text-sm mb-1">Moderate</p>
                <p className="text-xl font-bold text-text-body">$25K/mo</p>
                <p className="text-red text-sm">$300K/year</p>
              </div>
              <div>
                <p className="text-text-muted text-sm mb-1">Aggressive</p>
                <p className="text-xl font-bold text-text-body">$40K/mo</p>
                <p className="text-red text-sm">$480K/year</p>
              </div>
            </div>
        ...
        <FadeInOnScroll delay={0.2}>
          <Card variant="highlight" padding="large" className="text-center max-w-2xl mx-auto">
            <TrendingUp className="w-10 h-10 text-green mx-auto mb-4" />
