          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="p-6 bg-card rounded-xl border border-success/20 text-center">
                ...
                <p className="text-sm text-text-muted mb-3">Retention at 6 Months</p>
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  <tr className="border-b border-border-subtle">
                    ...
                    <td className="py-3 px-4 text-right text-success font-medium">$50,000/mo new MRR</td>
                  </tr>
                  <tr className="border-b border-border-subtle">
          ...
          <div className="mb-16 p-8 bg-elevated rounded-xl border border-success/30">
            ...
            <div className="p-6 bg-base rounded-lg border border-accent/20">
              ...
              <ul className="space-y-2 text-text-secondary text-sm">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-success">→</span>
                  75% retention at 6 months = clients worth <span className="text-success font-medium">$2,000+</span> LTV
                </li>
              </ul>
            </div>
