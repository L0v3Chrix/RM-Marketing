...
import { Phone, Calendar, FileText, Users, ArrowRight, Check } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            {TEAM_MEMBERS.map((member, index) => (
              <div key={index} className="p-6 bg-card rounded-xl border border-border-subtle">
                ...
                <h3 className="text-xl font-semibold text-text-primary mb-1 text-center md:text-left">{member.name}</h3>
                <p className="text-accent font-medium text-sm mb-4 text-center md:text-left">{member.role}</p>
        ...
        <FadeInOnScroll delay={0.2}>
          <div className="mb-16 p-8 bg-elevated rounded-xl border border-accent/30">
            ...
            <p className="text-2xl font-bold text-accent text-center mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="p-6 bg-base rounded-xl text-center">
                ...
                <p className="text-text-primary font-medium">When Chrix is CLOSING...</p>
                <p className="text-success font-bold">Sarah is BOOKING.</p>
              </div>
              ...
              <div className="p-6 bg-base rounded-xl text-center">
                ...
                <p className="text-text-primary font-medium">When Sarah is BOOKING...</p>
                <p className="text-accent font-bold">Chrix is CLOSING.</p>
              </div>
            </div>
        ...
        <FadeInOnScroll delay={0.4}>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="p-6 bg-card rounded-xl border border-border-subtle text-center">
              ...
              <h4 className="font-semibold text-text-primary mb-2">No Junior Staff</h4>
            ...
            <div className="p-6 bg-card rounded-xl border border-border-subtle text-center">
              ...
              <h4 className="font-semibold text-text-primary mb-2">Direct Access</h4>
              <p className="text-text-muted text-sm">
            ...
            <div className="p-6 bg-card rounded-xl border border-success/20 text-center">
              ...
              <h4 className="font-semibold text-text-primary mb-2">Aligned Incentives</h4>
              <p className="text-text-muted text-sm">
