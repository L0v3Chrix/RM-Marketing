          ...
          return (
            ...
            >
              <div className="w-20 sm:w-28 text-right flex-shrink-0">
                <span className="text-[10px] sm:text-xs text-text-muted uppercase tracking-tight">{stage.label}</span>
              </div>
              <div className="flex-1 relative h-7 sm:h-8">
                ...
                >
                  <span className="text-[10px] sm:text-xs font-bold text-base whitespace-nowrap">
                    {stage.value}
                  </span>
                </motion.div>
              </div>
