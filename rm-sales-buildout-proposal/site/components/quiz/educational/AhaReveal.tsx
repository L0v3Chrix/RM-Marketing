  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="bg-elevated rounded-2xl p-5 sm:p-6"
      >
        <div className="grid grid-cols-2 gap-4 mb-4">
          ...
          <div className="text-center">
            ...
            <div className={`
              ...
              ${isCorrect ? 'text-success' : 'text-text-secondary'}
            `}>
              {userOption?.label}
            </div>
          </div>
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-text-primary font-semibold text-sm sm:text-base mb-1">
